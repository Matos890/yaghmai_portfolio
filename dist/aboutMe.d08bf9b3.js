...
})({"7H3wg":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3bc95309d08bf9b3";
"use strict";
...
},{}],"9BVbU":[function(require,module,exports) {
var global = arguments[3];
// modules are defined as an array
// [ module function, map of requires ]
//
...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "kx4kz": [
        function(require, module1, exports) {
            ...
            var HMR_ENV_HASH = "d6ea1d42532a7575";
            var HMR_USE_SSE = false;
            module1.bundle.HMR_BUNDLE_ID = "4c74fe43c064fd94";
            "use strict";
            /* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE, HMR_USE_SSE, chrome, browser, __parcel__import__, __parcel__importScripts__, ServiceWorkerGlobalScope */ /*::
import type {
  HMRAsset,
...
${frame.code}`;
    ...
    "f2QDv": [
        function(require, module1, exports) {
            ...
            //////////////////////////////////////////////////////////////////
            var _scrollingTitleAnimation = require("./modules/scrollingTitleAnimation");
            ////////////////ANIMAZIONE ALTERNATIVA
            //////////////////////////////////////////////////////////////////
            var _animazioneHome = require("./modules/animazioneHome");
            ///////////////////////////MENU////////////////////////////////////
            /////////////////////////////////////////////////////////////////
            ...
            (0, _gsapDefault.default).registerPlugin(_all.ScrollTrigger);
            ...
            document.addEventListener("DOMContentLoaded", ()=>{
                (0, _pageTranstionHome.initializeTransitionHome)();
            });
    ...
    "fPSuC": [
        function(require, module1, exports) {
            ...
            var gsapWithCSS = (0, _gsapCoreJs.gsap).registerPlugin(_csspluginJs.CSSPlugin) || _gsapCoreJs.gsap, TweenMaxWithCSS = gsapWithCSS.core.Tween;
        },
        {
            "./gsap-core.js": "05eeC",
            "./CSSPlugin.js": "l02JQ",
...
*/ _easeMap = {}, _customEaseExp = /^[\d.\-M][\d.\-,\s]/, _quotesExp = /["']/g, _parseObjectInString = function _parseObjectInString(value) {
                ...
                _proto.then = function then(onFulfilled) {
                    ...
                    return new Promise(function(resolve) {
                        var f = _isFunction(onFulfilled) ? onFulfilled : _passThrough, _resolve = function _resolve() {
                            ...
                            self1.then = null; // temporarily null the then() method to avoid an infinite loop (see https://github.com/greensock/GSAP/issues/322)
                            _isFunction(f) && (f = f(self1)) && (f.then || f === self1) && (self1.then = _then);
                            resolve(f);
                            self1.then = _then;
                        };
                        if (self1._initted && self1.totalProgress() === 1 && self1._ts >= 0 || !self1._tTime && self1._ts < 0) _resolve();
                        else self1._prom = _resolve;
                    });
                };
        ...
        */ if (iteration !== prevIteration && !this._lock) {
                ...
                _proto2.totalDuration = function totalDuration(value) {
                    ...
                    if (arguments.length) return self1.timeScale((self1._repeat < 0 ? self1.duration() : self1.totalDuration()) / (self1.reversed() ? -value : value));
                    if (self1._dirty) {
                        parent = self1.parent;
                        while(child){
                            ...
                            if (start > prevStart && self1._sort && child._ts && !self1._lock) {
                                ...
                                self1._lock = 1; //prevent endless recursive calls - there are methods that get triggered that check duration/totalDuration when we add().
...
*/ /* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            ...
            var _win, _doc, _docElement, _pluginInitted, _tempDiv, _tempDivStyler, _recentSetterPlugin, _reverting, _windowExists = function _windowExists() {
                ...
                cache = parent._gsap;
                if (cache && toPercent && cache.width && horizontal && cache.time === _gsapCoreJs._ticker.time && !cache.uncache) return (0, _gsapCoreJs._round)(curValue / cache.width * amount);
                else {
 ...
 */ _identity2DMatrix = [
            ...
            var CSSPlugin = {
                ...
                init: function init(target, vars, tween, index, targets) {
                    ...
                    for(p in vars){
                        ...
                        endValue = vars[p];
                        if (_gsapCoreJs._plugins[p] && (0, _gsapCoreJs._checkPlugin)(p, vars, tween, index, target, targets)) continue;
                        ...
                        if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
                            ...
                            if (startAt && p in startAt) {
                                ...
                                (0, _gsapCoreJs.getUnit)(startValue + "") || startValue === "auto" || (startValue += _gsapCoreJs._config.units[p] || (0, _gsapCoreJs.getUnit)(_get(target, p)) || ""); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                            ...
                            if (isTransformRelated) {
                                ...
                                if (p === "scale") {
                                    this._pt = new _gsapCoreJs.PropTween(this._pt, cache, "scaleY", cache.scaleY, (relative ? (0, _gsapCoreJs._parseRelative)(cache.scaleY, relative + endNum) : endNum) - cache.scaleY || 0, _renderCSSProp);
                                    this._pt.u = 0;
                                    props.push("scaleY", p);
                                    p += "X";
                            ...
                            if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !_complexExp.test(endValue) && p in style) {
                                ...
                                endUnit = (0, _gsapCoreJs.getUnit)(endValue) || (p in _gsapCoreJs._config.units ? _gsapCoreJs._config.units[p] : startUnit);
                                startUnit !== endUnit && (startNum = _convertToUnit(target, p, startValue, endUnit));
                                this._pt = new _gsapCoreJs.PropTween(this._pt, isTransformRelated ? cache : style, p, startNum, (relative ? (0, _gsapCoreJs._parseRelative)(startNum, relative + endNum) : endNum) - startNum, !isTransformRelated && (endUnit === "px" || p === "zIndex") && vars.autoRound !== false ? _renderRoundedCSSProp : _renderCSSProp);
    ...
    "3UJRo": [
        function(require, module1, exports) {
            ...
            var gsapWithCSS = (0, _gsapCoreJsDefault.default).registerPlugin(_csspluginJsDefault.default) || _gsapCoreJsDefault.default, TweenMaxWithCSS = gsapWithCSS.core.Tween;
        },
        {
            "./gsap-core.js": "05eeC",
            "./CSSPlugin.js": "l02JQ",
            "./CustomEase.js": false,
            "./Draggable.js": false,
            "./CSSRulePlugin.js": false,
            "./EaselPlugin.js": false,
            "./EasePack.js": false,
            "./Flip.js": false,
            "./MotionPathPlugin.js": false,
            "./Observer.js": false,
            "./PixiPlugin.js": false,
            "./ScrollToPlugin.js": false,
            ...
            var Observer = /*#__PURE__*/ function() {
                ...
                _proto.init = function init(vars) {
                    ...
                    var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self1 = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target), ownerDoc = target.ownerDocument || _doc, deltaX = [
                        ...
                        onChange && (changedX || changedY) && onChange(self1, dx, dy, deltaX, deltaY); // in ScrollTrigger.normalizeScroll(), we need to know if it was touch/pointer so we need access to the deltaX/deltaY Arrays before we clear them out.
                        if (changedX) {
                        ...
                        locked && (locked = false, true) && onLockAxis && onLockAxis(self1);
                        if (wheeled) {
                            onWheel(self1);
                            wheeled = false;
                        }
                        ...
                        if (axis !== "y") {
                            deltaX[2] += x;
                            self1._vx.update(x, true); // update the velocity as frequently as possible instead of in the debounced function so that very quick touch-scrolls (flicks) feel natural. If it's the mouse/touch/pointer, force it so that we get snappy/accurate momentum scroll.
                        }
                        if (axis !== "x") {
                            deltaY[2] += y;
                        ...
                        self1._vx.reset(); // otherwise the t2 may be stale if the user touches and flicks super fast and releases in less than 2 requestAnimationFrame ticks, causing velocity to be 0.
                        self1._vy.reset();
...
*/ /* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            ...
            var _observerJs = require("./Observer.js");
            var gsap, _coreInitted, _win, _doc, _docEl, _body, _root, _resizeDelay, _toArray, _clamp, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp(value, type, self1) {
            ...
            _parsePosition = function _parsePosition(value, trigger, scrollerSize, direction, scroll, marker, markerScroller, self1, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation, clampZeroProp) {
                ...
                if (!_isNumber(value)) {
                    ...
                    element = (0, _observerJs._getTarget)(trigger, self1) || _body;
            ...
            _getTweenCreator = function _getTweenCreator(scroller, direction) {
                var getScroll = (0, _observerJs._getScrollFunc)(scroller, direction), prop = "_scroll" + direction.p2, getTween = function getTween(scrollTo, vars, initialValue, change1, change2) {
            ...
            var ScrollTrigger = /*#__PURE__*/ function() {
                ...
                _proto.init = function init(vars, animation) {
                    ...
                    var _vars = vars, onUpdate = _vars.onUpdate, toggleClass = _vars.toggleClass, id = _vars.id, onToggle = _vars.onToggle, onRefresh = _vars.onRefresh, scrub = _vars.scrub, trigger = _vars.trigger, pin = _vars.pin, pinSpacing = _vars.pinSpacing, invalidateOnRefresh = _vars.invalidateOnRefresh, anticipatePin = _vars.anticipatePin, onScrubComplete = _vars.onScrubComplete, onSnapComplete = _vars.onSnapComplete, once = _vars.once, snap = _vars.snap, pinReparent = _vars.pinReparent, pinSpacer = _vars.pinSpacer, containerAnimation = _vars.containerAnimation, fastScrollEnd = _vars.fastScrollEnd, preventOverlaps = _vars.preventOverlaps, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? _observerJs._horizontal : _observerJs._vertical, isToggle = !scrub && scrub !== 0, scroller = (0, _observerJs._getTarget)(vars.scroller || _win), scrollerCache = gsap.core.getCache(scroller), isViewport = _isViewport(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : (0, _observerJs._getProxyProp)(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [
                        vars.onEnter,
                        vars.onLeave,
                        vars.onEnterBack,
                        vars.onLeaveBack
                    ...
                    if ("refreshPriority" in vars) {
                        _sort = 1;
                        vars.refreshPriority === -9999 && (_primary = self1); // used by ScrollSmoother
                    }
                    ...
                    if (snap) {
                        ...
                        snapDelayedCall = gsap.delayedCall(snap.delay || scrubSmooth / 2 || 0.1, function() {
                            ...
                            } else if (self1.isActive && lastSnap !== scroll) snapDelayedCall.restart(true);
                        }).pause();
                    }
                    id && (_ids[id] = self1);
                    trigger = self1.trigger = (0, _observerJs._getTarget)(trigger || pin !== true && pin); // if a trigger has some kind of scroll-related effect applied that could contaminate the "y" or "x" position (like a ScrollSmoother effect), we needed a way to temporarily revert it, so we use the stRevert property of the gsCache. It can return another function that we'll call at the end so it can return to its normal state.
                    ...
                    if (markers) {
                        ...
                        if (!useFixedPosition && !(_observerJs._proxies.length && (0, _observerJs._getProxyProp)(scroller, "fixedMarkers") === true)) {
                    ...
                    self1.revert = function(revert, temp) {
                        if (!temp) return self1.kill(true);
                        // for compatibility with gsap.context() and gsap.matchMedia() which call revert()
                        var r = revert !== false || !self1.enabled, prevRefreshing = _refreshing;
                        if (r !== self1.isReverted) {
                            if (r) {
                                prevScroll = Math.max(scrollFunc(), self1.scroll.rec || 0); // record the scroll so we can revert later (repositioning/pinning things can affect scroll position). In the static refresh() method, we first record all the scroll positions as a reference.
                            ...
                            if (r) {
                                _refreshing = self1;
                                self1.update(r); // make sure the pin is back in its original position so that all the measurements are correct. do this BEFORE swapping the pin out
                            }
                            ...
                            r || self1.update(r); // when we're restoring, the update should run AFTER swapping the pin into its pin-spacer.
                    ...
                    self1.refresh = function(soft, force, position, pinOffset) {
                        ...
                        if ((_refreshing || !self1.enabled) && !force) return;
                        ...
                        self1._subPinOffset = false; // we'll set this to true in the sub-pins if we find any
                        var size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max = containerAnimation ? containerAnimation.duration() : _maxScroll(scroller, direction), isFirstRefresh = change <= 0.01, offset = 0, otherPinOffset = pinOffset || 0, parsedEnd = _isObject(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = _isObject(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self1.pinnedContainer = vars.pinnedContainer && (0, _observerJs._getTarget)(vars.pinnedContainer, self1), triggerIndex = trigger && Math.max(0, _triggers.indexOf(self1)) || 0, i = triggerIndex, cs, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
                        ...
                        while(i--){
                            ...
                            curTrigger.end || curTrigger.refresh(0, 1) || (_refreshing = self1); // if it's a timeline-based trigger that hasn't been fully initialized yet because it's waiting for 1 tick, just force the refresh() here, otherwise if it contains a pin that's supposed to affect other ScrollTriggers further down the page, they won't be adjusted properly.
                        ...
                        if (pin && !(_clampingMax && self1.end >= _maxScroll(scroller, direction))) {
                            ...
                            oppositeScroll = useFixedPosition && (0, _observerJs._getScrollFunc)(scroller, isVertical ? _observerJs._horizontal : _observerJs._vertical)();
                            if (pinSpacing) {
                                spacerState = [
                        ...
                        isFirstRefresh && !_refreshingAll && self1.update(); // edge case - when you reload a page when it's already scrolled down, some browsers fire a "scroll" event before DOMContentLoaded, triggering an updateAll(). If we don't update the self.progress as part of refresh(), then when it happens next, it may record prevProgress as 0 when it really shouldn't, potentially causing a callback in an animation to fire again.
                    ...
                    self1.endAnimation = function() {
                        ...
                        if (animation) scrubTween ? scrubTween.progress(1) : !animation.paused() ? _endAnimation(animation, animation.reversed()) : isToggle || _endAnimation(animation, self1.direction < 0, 1);
                    };
                        ...
                        if (clipped !== prevProgress && self1.enabled) {
                            ...
                            if (stateChanged && !_refreshing) {
                                ...
                                if (toggled || !_limitCallbacks) {
                                    ...
                                    once && (clipped === 1 ? self1.kill(false, 1) : callbacks[toggleState] = 0); // a callback shouldn't be called again if once is true.
                                    if (!toggled) {
                            ...
                            } else if (isToggle && onUpdate && !_refreshing) onUpdate(self1);
                    ...
                    self1.disable = function(reset, allowAnimation) {
                        if (self1.enabled) {
                            ...
                            if (!isViewport) {
                                ...
                                while(i--){
                                    if (_triggers[i].scroller === scroller && _triggers[i] !== self1) return; //don't remove the listeners if there are still other triggers referencing it.
                                }
                ...
                ScrollTrigger.enable = function enable() {
                    ...
                    if (gsap) {
                        ...
                        if (_body) {
                            ...
                            ScrollTrigger.isTouch = _observerJs.Observer.isTouch;
                            ...
                            _ignoreMobileResize = _observerJs.Observer.isTouch === 1;
                            ...
                            _observerJs._vertical.m = Math.round(bounds.top + (0, _observerJs._vertical).sc()) || 0; // accommodate the offset of the <body> caused by margins and/or padding
                            _observerJs._horizontal.m = Math.round(bounds.left + (0, _observerJs._horizontal).sc()) || 0;
            ...
            ScrollTrigger.getScrollFunc = function(element, horizontal) {
                return (0, _observerJs._getScrollFunc)((0, _observerJs._getTarget)(element), horizontal ? _observerJs._horizontal : _observerJs._vertical);
            };
            ...
            var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
                ...
                var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self1, maxY, target = (0, _observerJs._getTarget)(vars.target) || _docEl, smoother = gsap.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && (0, _observerJs._getTarget)(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = (0, _observerJs._getScrollFunc)(target, _observerJs._vertical), scrollFuncX = (0, _observerJs._getScrollFunc)(target, _observerJs._horizontal), scale = 1, initialScale = (_observerJs.Observer.isTouch && _win.visualViewport ? _win.visualViewport.scale * _win.visualViewport.width : _win.outerWidth) / _win.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction(momentum) ? function() {
                ...
                vars.onRelease = vars.onGestureStart = function(self1, wasDragging) {
                    ...
                    if (!wasDragging) onStopDelayedCall.restart(true);
                        ...
                        if (normalizeScrollX) {
                            ...
                            endScroll = currentScroll + dur * 0.05 * -self1.velocityX / 0.227; // the constant .227 is from power4(0.05). velocity is inverted because scrolling goes in the opposite direction.
                        ...
                        endScroll = currentScroll + dur * 0.05 * -self1.velocityY / 0.227; // the constant .227 is from power4(0.05)
                ...
                vars.onChange = function(self1, dx, dy, xArray, yArray) {
                    ...
                    dx && normalizeScrollX && scrollFuncX(scrollClampX(xArray[2] === dx ? startScrollX + (self1.startX - self1.x) : scrollFuncX() + dx - xArray[1])); // for more precision, we track pointer/touch movement from the start, otherwise it'll drift.
                    if (dy) {
                        scrollFuncY.offset && removeContentOffset();
    ...
    "fLOTs": [
        function(require, module1, exports) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports);
            parcelHelpers.export(exports, "initializeNav", ()=>initializeNav);
    ...
    "b19BA": [
        function(require, module1, exports) {
            ...
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports);
            parcelHelpers.export(exports, "initializeScrollAnimations", ()=>initializeScrollAnimations);
            var _gsap = require("gsap");
            var _gsapDefault = parcelHelpers.interopDefault(_gsap);
            var _all = require("gsap/all");
            var _gsapCore = require("gsap/gsap-core");
            ...
            const initializeScrollAnimations = ()=>{
                ...
                if (titleInfo) {
                    ...
                    let mattiaPicScroll = (0, _gsapDefault.default).from(mattiaPic, {
                        x: ()=>300,
                        duration: 0.8,
                        ease: "power1.inOut",
                        scrollTrigger: {
                    ...
                    let coverDevScroll = (0, _gsapDefault.default).from(".imgCoverDev", {
                        y: ()=>400,
                        duration: 1,
                        ease: "power1.inOut",
                        scrollTrigger: {
                    ...
                    let coverMapScroll = (0, _gsapDefault.default).from(".mapImage", {
                        y: ()=>400,
                        duration: 1,
                        ease: "power1.inOut",
                        scrollTrigger: {
                    ...
                    let coverMotionScroll = (0, _gsapDefault.default).from(".videoImage", {
                        y: ()=>400,
                        duration: 1,
                        ease: "power1.inOut",
                        scrollTrigger: {
        ...
        function(require, module1, exports) {
            ...
            function initializeAnimation() {
                ...
                window.addEventListener("resize", debounce(()=>{
                    ...
                    tl1.kill();
                    tl2.kill();
                    (0, _gsapDefault.default).killTweensOf(tl1);
                    (0, _gsapDefault.default).killTweensOf(tl2);
    ...
    "7FeRP": [
        function(require, module1, exports) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports);
            parcelHelpers.export(exports, "initializeMenu", ()=>initializeMenu);
            var _gsap = require("gsap");
            var _gsapDefault = parcelHelpers.interopDefault(_gsap);
    ...
    "85FTH": [
        function(require, module1, exports) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports);
            parcelHelpers.export(exports, "initializeTransitionHome", ()=>initializeTransitionHome);
            var _gsap = require("gsap");
            var _gsapDefault = parcelHelpers.interopDefault(_gsap);
            var _all = require("gsap/all");
            var _gsapCore = require("gsap/gsap-core");
            (0, _gsapDefault.default).registerPlugin(_all.ScrollTrigger);
            function initializeTransitionHome() {
                if (document.title === "Mattia Yaghmai - portfolio") window.addEventListener("pageshow", ()=>{
                    ...
                    const transitionEl1 = document.querySelector(".transition");
                    const anchors = document.querySelectorAll(".linkPages");
                    setTimeout(()=>{
                        transitionEl1.classList.remove("is-active");
                    }, 500);
                    for(let i = 0; i < anchors.length; i++){
                        ...
                        anchor.addEventListener("click", (e)=>{
                            ...
                            transitionEl1.classList.add("is-active");
                            setTimeout(()=>{
    ...
    "iquZy": [
        function(require, module1, exports) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports);
            parcelHelpers.export(exports, "initializeTransitionAbout", ()=>initializeTransitionAbout);
            var _gsap = require("gsap");
            var _gsapDefault = parcelHelpers.interopDefault(_gsap);
            var _all = require("gsap/all");
            var _gsapCore = require("gsap/gsap-core");
            (0, _gsapDefault.default).registerPlugin(_all.ScrollTrigger);
            function initializeTransitionAbout() {
            ...
            function animatePage(wordsToAnimate) {
                ...
                timeLineTransition.from(transitionEl1, {
                    y: `0vh`,
                    duration: 2,
                    onComplete: function() {
                        if (transitionEl1) transitionEl1.parentNode.removeChild(transitionEl1);
                    }
                });
                timeLineTransition.from(titles, {
                    y: 500,
                    duration: 1.5,
                    ease: "easeIn"
                }, "textReveal");
                timeLineTransition.from(wordsToAnimate, {
                    y: 500,
                    scale: 0.5,
                    duration: 1.5,
                    ease: "easeIn",
            ...
            function scrollingELements() {
                const scrollingElementsWork = document.querySelectorAll(".scrollingElementWork");
                const elementTriggerWork = document.querySelectorAll(".elementTriggerWork");
                scrollingElementsWork.forEach((element, i)=>{
                    (0, _gsapDefault.default).from(element, {
                        y: 200,
                        delay: 0.2,
                        duration: 1,
    ...
    "kx4kz",
    "f2QDv"
], "f2QDv", "parcelRequire7f5a");

},{}]},["7H3wg","9BVbU"], "9BVbU", "parcelRequire7f5a")

//# sourceMappingURL=aboutMe.d08bf9b3.js.map
