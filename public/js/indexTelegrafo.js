...
if (cover) {
  ...
  //IMAGES
  const imageSources = [
    "./public/img/Emblemata_1624_bookmark_1.jpg",
    "./public/img/chappebackground.png",
    "./public/img/Franklin_hand_bookmark_2.jpg",
    "./public/img/magnetism1background.png",
    "./public/img/Faraday.png",
    "./public/img/henry.png",
    "./public/img/railwaymap.png",
    "./public/img/magnetismbackground2.png",
    "./public/img/giornalisti_bookmark_3.png",
    "./public/img/morsebackground.png",
    "./public/img/morse.png",
    "./public/img/testbackground.png",
    "./public/img/morseNotes.jpg",
    "./public/img/giornalistibackground.png",
    "./public/img/submarine_bookmark_4.jpg",
    "./public/img/shipbackground.png",
    "./public/img/cyrus.png",
    "./public/img/messagequeen.png",
    "./public/img/1871Telegraph lines.jpg",
    "./public/img/1880Telegraph lines.jpg",
    "./public/img/1901Telegraph lines.jpg",
    "./public/img/caricaturebackground.png",
  ];
